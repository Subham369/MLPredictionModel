package com.example.mlpredictionapp;
...
import com.example.mlpython.PyML;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textfile=findViewById(R.id.textView);
                ...
                if(ed1.getText().length()!=0&&ed2.getText().length()!=0&&ed3.getText().length()!=0&&ed4.getText().length()!=0)
                {
                    ...
                    switch (spinner.getSelectedItem().toString())
                    {
                        case  "Random Forest Model":
                            ...
                            String ans1= PyML.random_forest(MainActivity.this,v1,v2,v3,v4);
                        ...
                        case "Decision Tree Model":
                            ...
                            String ans2= PyML.decision_tree(MainActivity.this,v1,v2,v3,v4);
...
//                            break;
                        case "Extra Tree Model":
                            ...
                            //predict();
                            String ans3= PyML.extratree(MainActivity.this,v1,v2,v3,v4);
